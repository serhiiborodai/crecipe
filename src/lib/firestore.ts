...
const DEFAULT_SETTINGS: SiteSettings = {
  ...
  faq: [
    {
      question: 'Как я получу доступ к курсу после оплаты?',
      answer: 'Сразу после успешной оплаты курс появится в вашем личном кабинете. Вы получите уведомление на email, и сможете начать просмотр немедленно. Никаких ожиданий — доступ моментальный.',
    },
    {
      question: 'На какой срок я получаю доступ к купленному курсу?',
      answer: 'Навсегда! Все купленные курсы остаются у вас пожизненно. Вы можете пересматривать их сколько угодно раз в любое удобное время.',
    },
    {
      question: 'Могу ли я смотреть курсы на телефоне?',
      answer: 'Да, наш сайт полностью адаптирован для мобильных устройств. Смотрите курсы на смартфоне, планшете или компьютере — как вам удобнее.',
    },
    {
      question: 'Какие способы оплаты вы принимаете?',
      answer: 'Мы принимаем банковские карты Visa, Mastercard, а также Apple Pay и Google Pay. Все платежи защищены и обрабатываются через безопасную платёжную систему Stripe.',
    },
    {
      question: 'Можно ли вернуть деньги, если курс мне не подойдёт?',
      answer: 'Если курс вам не подошёл, свяжитесь с нами в течение 7 дней после покупки — мы вернём деньги без лишних вопросов.',
    },
    {
      question: 'Нужен ли мне кулинарный опыт для прохождения курсов?',
      answer: 'Наши курсы рассчитаны на разный уровень подготовки. Каждый курс имеет отметку сложности — выбирайте подходящий. Даже новички смогут приготовить ресторанные блюда, следуя нашим пошаговым инструкциям.',
    },
  ],
